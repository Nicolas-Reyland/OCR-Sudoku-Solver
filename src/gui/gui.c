...
int main(int argc, char **argv)
{
    ...
    gtk_widget_set_tooltip_text(adjust_img_button, "Removes perspective from image and rotates it");
    ...
    gtk_box_pack_start(GTK_BOX(right_buttons_box), top_right_box, FALSE, FALSE, 10);
